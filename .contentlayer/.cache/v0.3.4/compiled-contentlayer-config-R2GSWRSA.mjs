...
var Service = defineDocumentType(() => ({
  ...
  computedFields: {
    path: {
      type: "string",
      resolve: (doc) => doc.parentService ? `/services/${doc.parentService}/${doc.slug}` : `/services/${doc.slug}`
    }
  }
}));
...
//# sourceMappingURL=compiled-contentlayer-config-R2GSWRSA.mjs.map
